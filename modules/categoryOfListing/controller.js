...
exports.add = async (req, res, next) => {
  try {
    ...
    redisService.del(`listing-categories`);
    redisService.del(`listing-category-sitemap`);
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    let data = await redisService.get(`listing-categories`);
    ...
    if (!data) {
      ...
      redisService.set(`listing-categories`, data);
    }
